//
//  Home_Recommend_CollectionDelegate.m
//  云花园
//
...
@implementation Home_Recommend_CollectionDelegate
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    Home_Recommend_CollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:identify forIndexPath:indexPath];
    [cell sizeToFit];
    if (!cell) {
